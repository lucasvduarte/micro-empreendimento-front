...
import { Action, ACTION_EDIT, ACTION_DELETE, ACTION_VIEW, ACTION_EDIT_SUBMIT, ACTION } from '../../interfaces/TableInterface';
...
function TableBodyComponent(props: TableBodyProps) {
    ...
    const closeEdit = () => {
        handleClickAction && handleClickAction(ACTION_EDIT_SUBMIT, newValue.values, newValue.index);
                        ...
                        <TableCell component="th" scope="row" key={`TableRowAction-${index}`} width={80}>
                            ...
                            {index === newValue.index &&
                                <ActionButton title="Cancelar">
                                    <Close fontSize="default" color="secondary" onClick={() => cancelEdit()} />
                                </ActionButton>
                            }
                        </TableCell>
                    )}
